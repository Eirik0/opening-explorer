...
REQUIREMENTS_DEV = NestedRequirements(
    'requirements/requirements-dev.txt', [REQUIREMENTS_PATH_STYLE, REQUIREMENTS_PATH_COVERAGE])
REQUIREMENTS_ALL = NestedRequirements(
    'requirements/requirements-all.txt', [REQUIREMENTS_PATH_PROD, REQUIREMENTS_PATH_STYLE, REQUIREMENTS_PATH_COVERAGE])
